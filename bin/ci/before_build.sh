...
CTL=${ZIG_HTTP_API_CLIENT_RABBITMQCTL:="sudo rabbitmqctl"}
PLUGINS=${ZIG_HTTP_API_CLIENT_RABBITMQ_PLUGINS:="sudo rabbitmq-plugins"}
...
# Enable plugins exercised by federation/streams/shovel tests
